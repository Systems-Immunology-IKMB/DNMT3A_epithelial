...
# Template for performing RnBeads analyses - 
...
report.dir <- file.path(analysis.dir, "reports_baseline/")

sample.annotation <- file.path(data.dir, "annotation_baseline.csv")
data.type<-"idat.dir"
...
rnb.options(qc.snp.heatmap = FALSE)
...
rnb.options(differential.comparison.columns = c("Genotype"))
